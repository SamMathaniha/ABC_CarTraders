...
{
    public partial class ClientMyProfile : Form
    {
        ...
        public ClientMyProfile()
        {
            ...
            label1.Text = UserSession.Name; // Display the user's name from UserSession
            label2.Text = UserSession.NIC; // Display the user's name from UserSession
        ...
        private void ClientMyProfile_Load(object sender, EventArgs e)
        {
        ...
        private void txtbcUserPhoneNo_TextChanged(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                try
                {
                    ...
                    if (rowsAffected > 0)
                    {
                        ...
                        label1.Text = txtbxUserName.Text;
                    }
                    else
                    {
